# Bringing 3D Generation to the Browser: A Developer's Guide to the Meshy Chrome Extension
...
## 1. The Problem: Prototyping 3D is Too Slow
...
*P.S. We consider this extension a working prototype! If you have any questions, run into bugs, or have ideas for improvements, please feel free to [open an issue on our GitHub repository](https://github.com/rpaik/meshy-chrome-extension/issues).*
